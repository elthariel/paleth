...
module Paleth
  ...
  #
  # Create a Paleth web instance. Without any arguments, it'll try to initialize
  # using `web3.currentProvider`, or you can initialize it manually by
  # providing the following keyword arguments:
  #
